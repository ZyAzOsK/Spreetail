...
request.user = User.objects.get(username='Aisha')
# We need to simulate application/json parsing for request.data in DRF
# Since we are calling the view directly without the DRF machinery, we mock request.data
